...
class PatientLoginView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final viewModel = Get.put(PatientLoginViewModel(), tag: 'patient_login');
    final screenHeight = MediaQuery.of(context).size.height;
    final screenWidth = MediaQuery.of(context).size.width;

    return Scaffold(
      backgroundColor: AppColors.backgroundColor,
      appBar: const CustomAppBar(title: "Patient Login", showBackButton: true),
      body: SafeArea(
        child: LayoutBuilder(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () => Get.toNamed(AppRoutes.patientRegister),
                            child: Text(
                              "Sign Up",
                              style: AppFonts.bodyMedium.copyWith(
